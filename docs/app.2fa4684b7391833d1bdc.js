...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('TEST', ['ui.router', _todo2.default, _ng_model2.default, _editableArea2.default]).config(["$stateProvider", "$urlRouterProvider", function ($stateProvider, $urlRouterProvider) {
	    'ngInject';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = angular.module('TODO', [_todoForm2.default, _todoList2.default, _radio2.default]).component('todo', {
		...
		controller: ["service", function controller(service) {
			'ngInject';
